...
const CodeMinorIcon = (props: ESSvgIconProps) => (
  <ESSvgIcon {...props}>
    ...
    <path d="M12.626 5.284a1.002 1.002 0 0 0-1.63.346l-1.998 4-1.998 4a.999.999 0 0 0 .56 1.299 1.006 1.006 0 0 0 1.302-.557l3.995-8a1.001 1.001 0 0 0-.231-1.088Z" />
  </ESSvgIcon>
);

export default CodeMinorIcon;
