...
const PaintBrushIcon = (props: ESSvgIconProps) => (
  <ESSvgIcon {...props}>
    <path d="M20 18c0-.79-1.018-2.488-1.601-3.397a.47.47 0 00-.798 0C17.018 15.512 16 17.21 16 18c0 1.107.893 2 2 2s2-.893 2-2z" />
